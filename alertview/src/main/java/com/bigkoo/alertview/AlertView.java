...
public class AlertView {
    ...
    /**  窗口模式左右两边到屏幕的间距DP */
    private int marginAlertLefRight = 0;

    public AlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, int margin_alert_left_right, OnItemClickListener onItemClickListener){
        this.context = context;
        if(style != null)this.style = style;
        this.onItemClickListener = onItemClickListener;
        this.marginAlertLefRight = margin_alert_left_right;
        this.context = context;
    ...
    protected void initViews(){
        ...
        switch (style){
            case ActionSheet:
                ...
                margin_alert_left_right = marginAlertLefRight;
...
//                    tvAlert.setTypeface(Typeface.DEFAULT_BOLD);
    ...
    public void setMarginBottom(int marginBottom){
        int margin_alert_left_right = marginAlertLefRight;
